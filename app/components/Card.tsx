...
import { TrendingUp, MapPin, ArrowLeft, ArrowRight, Bookmark, DollarSign, Clock } from 'lucide-react';
      ...
      {variant === 'listing' && (
        <>
          ...
          <div className="relative aspect-[3/2] w-full overflow-hidden group-hover:opacity-95 transition-opacity border-b border-gray-100">
             ...
             <div className={`absolute top-2 z-10 ${direction === 'rtl' ? 'left-2' : 'right-2'}`}>
                 {typeof badge === 'string' ? (
