                ...
                <tbody className="divide-y divide-gray-100">
                   ...
                   {formData.assets.map((asset: { name: string; quantity: string; value: string; date: string }, idx: number) => (
                      <tr key={idx}>
                         ...
                         <td className="p-2"><input type="number" className={cn("w-full bg-transparent border-none focus:ring-0 p-0 text-sm placeholder:text-xs text-gray-600", direction === 'rtl' ? "text-right" : "text-left")} placeholder={isAr ? 'ريال' : 'SAR'} value={asset.price} onChange={e => {
             ...
             <table className={cn("w-full text-sm", direction === 'rtl' ? "text-right" : "text-left")}>
                <thead className="bg-gray-50 text-gray-500 font-bold border-b border-gray-200 text-xs">
                   <tr>
                      ...
                      <th className="p-3 w-32 md:w-40">{isAr ? 'القيمة (ريال)' : 'Amount (SAR)'}</th>
              ...
              <table className={cn("w-full text-sm", direction === 'rtl' ? "text-right" : "text-left")}>
                <thead className="bg-gray-50 text-gray-500 font-bold border-b border-gray-200 text-xs">
                  <tr>
                    ...
                    <th className="p-3 w-36">{isAr ? 'القيمة (ريال)' : 'Value (SAR)'}</th>
                    <th className="p-3 w-10"></th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
